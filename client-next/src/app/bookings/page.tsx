        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 space-y-6">
          ...
          <div className="border-b border-slate-200 flex gap-8 text-sm font-semibold px-2">
            <button
              ...
              className={`pb-3 transition relative cursor-pointer ${activeTab === "upcoming"
            ...
            <button
              ...
              className={`pb-3 transition relative cursor-pointer ${activeTab === "past"
                  ? "text-[#003580] border-b-2 border-[#003580]"
                  : "text-slate-500 hover:text-slate-800"
                }`}
            >
            ...
            <button
              ...
              className={`pb-3 transition relative cursor-pointer ${activeTab === "cancelled"
                  ? "text-[#003580] border-b-2 border-[#003580]"
                  : "text-slate-500 hover:text-slate-800"
                }`}
            >
