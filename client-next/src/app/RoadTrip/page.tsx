...
export default function RoadTripPage() {
  ...
  const handleBooking = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log({ vehicleType, selectedDate });
    alert(`Road trip booked! Vehicle: ${vehicleType}, Date: ${selectedDate}`);
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-950 text-white px-4 py-10 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-300">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={16} className="text-emerald-400" /> Comprehensive Auto Insurance
                </li>
                <li className="flex items-center gap-2">
